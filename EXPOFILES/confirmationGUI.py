...
def goToCommand(UIController, medName):
	...
	print("Click")
	individualConfirm(UIController, medName=medName, folderPath=medName)
	pass
...
def confirmGui(UIController: UIController, hour: str='00', minute: str='00'):
	...
	UIController.canvasIds["Confirm"].append(UIController.canvas.create_window(110,WINDOW_HEIGHT,window=VC_btn,anchor=tk.SW))
