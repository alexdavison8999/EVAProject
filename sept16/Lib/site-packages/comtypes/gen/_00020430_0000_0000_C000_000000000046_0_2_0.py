...
IFontDisp = Font
__all__ = [ 'IPictureDisp', 'OLE_HANDLE', 'IFont', 'IFontEventsDisp',
           'OLE_COLOR', 'OLE_XSIZE_HIMETRIC', 'Unchecked',
           'OLE_CANCELBOOL', 'OLE_YSIZE_HIMETRIC', 'IPicture',
           'Picture', 'OLE_ENABLEDEFAULTBOOL', 'Gray',
           'OLE_OPTEXCLUSIVE', 'Color', 'OLE_YSIZE_PIXELS',
           'VgaColor', 'OLE_XSIZE_PIXELS', 'FONTUNDERSCORE',
           'OLE_XPOS_HIMETRIC', 'IFontDisp', 'LoadPictureConstants',
           'Checked', 'Default', 'FONTSTRIKETHROUGH',
           'OLE_YPOS_PIXELS', 'StdFont', 'OLE_XPOS_CONTAINER',
           'OLE_XSIZE_CONTAINER', 'FONTSIZE', 'OLE_YSIZE_CONTAINER',
           'OLE_YPOS_HIMETRIC', 'OLE_TRISTATE', 'OLE_YPOS_CONTAINER',
           'FontEvents', 'Font', 'Monochrome', 'StdPicture',
           'OLE_XPOS_PIXELS', 'FONTITALIC', 'FONTBOLD', 'FONTNAME']
